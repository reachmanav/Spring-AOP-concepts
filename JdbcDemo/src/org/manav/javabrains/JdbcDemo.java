...
import org.manav.javabrains.dao.MyJdbcDaoImpl;
...
public class JdbcDemo {
	...
	public static void main(String[] args) {
		...
		MyJdbcDaoImpl dao2=(MyJdbcDaoImpl) ctx.getBean("myJdbcDaoImpl");
...
//		System.out.println(circle.getName());
		...
		dao2.insertCircleObject(new Circle(4,"Fourth Triangle"));
